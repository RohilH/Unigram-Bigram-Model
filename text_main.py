...
if __name__ == '__main__':
    ...
    # MNB.bigramfit(x_train, y_train)
    #
    # accuracy,pred = MNB.bigrampredict(x_test, y_test)
    compute_results(y_test,pred)
    classNames = ["Company", "EducationalInstitution", "Artist", "Athlete", "OfficeHolder", "MeanOfTransportation", "Building", "NaturalPlace", "Village", "Animal", "Plant", "Album", "Film", "WrittenWork"]

    plot_confusion_matrix(y_test, pred, classes=classNames, normalize=True,
